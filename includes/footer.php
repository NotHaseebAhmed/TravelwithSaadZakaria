<section class="layout-pt-md layout-pb-md bg-dark-2">
              ...
              <div class="row x-gap-30 y-gap-10">
                <div class="col-auto">
                  <div class="d-flex items-center">
                    © 2025 travelwithsaadzakaria.com LLC All rights reserved.
                  </div>
                </div>
              </div>
            </div>
 ...
 <!-- <script>
 $("#dateRange").flatpickr({ mode: "range" });
</script> -->
</body>


<!-- Mirrored from creativelayers.net/themes/gotrip-html/hotel-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 13:35:25 GMT -->
</html>