...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/home-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 13:34:54 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                <a href="login.html" class="button -white bg-blue-1 px-30 fw-400 text-14 h-50 text-white">Become An Expert</a>
                <a href="signup.html" class="button -outline-blue-1 px-30 fw-400 text-14 h-50 text-blue-1 ml-20">Sign In / Register</a>
              </div>
