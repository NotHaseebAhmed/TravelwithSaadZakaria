        ...
        o(".side-nav").length &&
            ...
            o(".side-nav a").each(function () {
                ...
                this.href == e &&
                    ...
                    "sidebar-menu" !== (e = o(this).parent().parent().parent().parent().parent().parent()).attr("id") &&
                        e.addClass("show"),
                    ...
                    var n = this,
                        e =
                            ...
                            document.querySelectorAll("input[name=data-layout]").forEach(function (t) {
                                t.addEventListener("change", function (e) {
                                    window.location =
                                        "horizontal" === t.value ? "layouts-horizontal.html" : "index.html";
                                });
                            }),
            ...
            },
            {
                ...
                value: function () {
                    ...
                    var e,
                        ...
                        s = this.config;
                    s &&
                        ((e = document.querySelector("input[type=checkbox][name=data-layout][value=" + s.nav + "]")),
                        (t = document.querySelector("input[type=checkbox][name=data-bs-theme][value=" + s.theme + "]")),
